...
public class BaseClass {
	...
	{
		String Randomgen=RandomStringUtils.randomAlphabetic(5);
		return Randomgen;
	}
	...
	{
		String Randomelpha=RandomStringUtils.randomAlphabetic(3);
		String Randomenum=RandomStringUtils.randomNumeric(3);
		return (Randomelpha+"@"+Randomenum);
	}
